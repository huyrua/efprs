...
namespace Infrastructure.Data.EntityFramework
{
    ...
    public class GenericRepository : IRepository
    {
        ...
        {
            //var entityName = GetEntityName<TEntity>();
            //Func<ObjectContext, Expression<Func<TEntity, bool>>, IQueryable<TEntity>> compiledQuery =
            //    CompiledQuery.Compile<ObjectContext, Expression<Func<TEntity, bool>>, IQueryable<TEntity>>((ctx, param) =>
            //        ctx.CreateQuery<TEntity>(entityName).Where(param));
            //return compiledQuery.Invoke(this.ObjectContext, predicate);
        ...
        private string GetEntityName<TEntity>() where TEntity : class
        {
            ...
            //return string.Format("{0}.{1}", ObjectContext.DefaultContainerName, pluralizer.Pluralize(typeof(TEntity).Name));
            ...
            string entitySetName = ObjectContext.MetadataWorkspace
